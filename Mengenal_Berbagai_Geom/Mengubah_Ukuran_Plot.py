...
# Bagaimana jika kita ingin membuat line chart untuk negara Singapura dan Indonesia di plot yang sama?
# Kita dapat mendefinisikan argumen color di fungsi aes().

# Isi argumen color dengan kolom negara yang ada di df_inflasi,
# agar kita mempunyai dua buah garis di plot kita: garis untuk Indonesia dan Singapura.
...
# Kita bisa lihat bahwa label di x-axis kita bertabrakan.
# Salah satu solusi yang dapat dilakukan adalah mengubah ukuran dari plot yang kita buat.

# Gunakan fungsi theme() dari plotnine,
# dan berikan argumen figure_size untuk mendefinisikan grafik berukuran 10x5.
# Figure_size menerima nilai berupa tuple yang berisi (panjang, tinggi) dalam inch.

# Note : Lebih lanjut tentang theme() dapat dibaca di
